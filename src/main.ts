...
import { Align3PointTool } from './tools/align3pt-tool';
...
const main = async () => {
    ...
    toolManager.register('align3Point', new Align3PointTool(events, scene, editorUI.toolsContainer.dom, editorUI.canvasContainer));
